...
class Registration:
    def __init__(self, root, ls, frame_old2):
        ...
        lbl_roll = Label(Manage_Frame, text="User ID", bg="LightBlue", fg="RED", font=("times new roman", 20, "bold"))
        ...
        lbl_Email = Label(Manage_Frame, text="Class", bg="LightBlue", fg="RED", font=("times new roman", 20, "bold"))
        ...
        self.Student_table.heading("Roll", text="User ID.")
    ...
    def add_data(self):
        ...
        # c.execute("INSERT INTO student_fees VALUES (?,?,?,)", (self.Roll_No_var.get(), '0', '0''3500'))
